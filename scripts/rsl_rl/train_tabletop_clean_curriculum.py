...
STAGES: tuple[StageConfig, ...] = (
    ...
    StageConfig(
        ...
        thresholds=(
            ...
            MetricThreshold("Metrics/left_hand_pose/target_age_steps", maximum=90.0),
            MetricThreshold("Metrics/left_hand_pose/hand_speed", maximum=0.75),
    ...
    StageConfig(
        ...
        success_patience=10,
        thresholds=(
            MetricThreshold("Episode_Termination/target_quota", minimum=0.72),
            MetricThreshold("Episode_Termination/target_timeout", maximum=0.18),
            ...
            MetricThreshold("Metrics/left_hand_pose/recover_success_flag", minimum=0.62),
            MetricThreshold("Metrics/left_hand_pose/hand_object_error", maximum=0.11),
            MetricThreshold("Metrics/left_hand_pose/target_age_steps", maximum=70.0),
            MetricThreshold("Metrics/left_hand_pose/hand_speed", maximum=0.70),
            MetricThreshold("Metrics/left_hand_pose/support_contact_flag", maximum=0.08),
    ...
    StageConfig(
        ...
        min_success_iteration=260,
        success_patience=12,
        thresholds=(
            MetricThreshold("Episode_Termination/target_quota", minimum=0.72),
            MetricThreshold("Episode_Termination/target_timeout", maximum=0.14),
            MetricThreshold("Episode_Termination/body_support_contact", maximum=0.05),
            MetricThreshold("Metrics/left_hand_pose/targets_completed", minimum=3.2),
            MetricThreshold("Metrics/left_hand_pose/touch_success_flag", minimum=0.86),
            MetricThreshold("Metrics/left_hand_pose/recover_success_flag", minimum=0.74),
            MetricThreshold("Metrics/left_hand_pose/hand_object_error", maximum=0.11),
            MetricThreshold("Metrics/left_hand_pose/hand_target_error", maximum=0.12),
            MetricThreshold("Metrics/left_hand_pose/target_age_steps", maximum=55.0),
            MetricThreshold("Metrics/left_hand_pose/hand_speed", maximum=0.65),
            MetricThreshold("Metrics/left_hand_pose/support_contact_flag", maximum=0.08),
