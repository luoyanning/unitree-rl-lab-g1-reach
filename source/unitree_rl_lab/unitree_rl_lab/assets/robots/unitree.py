...
UNITREE_ROS_DIR = "/mlp_vepfs/share/lyn/try0310/unitree_ros"  # Replace with the actual path to your unitree_ros package
...
UNITREE_G1_29DOF_HOMIE_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{UNITREE_ROS_DIR}/robots/g1_description/g1_29dof_rev_1_0.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
    ...
    actuators={
        # OpenHomie lower-body "M" control computes torques in the env and sends them to effort mode.
        # This explicit actuator path keeps the lower body on effort control without an implicit PD drive.
        ...
        "homie_waist": ImplicitActuatorCfg(
