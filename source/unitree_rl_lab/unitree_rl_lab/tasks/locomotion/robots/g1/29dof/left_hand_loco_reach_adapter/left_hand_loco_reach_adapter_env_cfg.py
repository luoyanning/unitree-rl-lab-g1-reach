...
from .left_hand_loco_reach_adapter_mdp import (
...
@configclass
class LeftHandLocoReachAdapterCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterCurriculumCfg = LeftHandLocoReachAdapterCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachAdapterPlayEnvCfg(RobotLeftHandLocoReachAdapterEnvCfg):
    def __post_init__(self):
        super().__post_init__()
