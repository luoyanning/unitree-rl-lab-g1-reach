...
from .left_hand_loco_reach_adapter_acquire_stay_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireStayCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireStayEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireStayCurriculumCfg = LeftHandLocoReachAdapterAcquireStayCurriculumCfg()
    ...
    def __post_init__(self):
        ...
        self.rewards.post_success_stay = RewTerm(
            ...
            params={
                "asset_cfg": ee_cfg,
                **long_horizon_params,
                "stay_reward_std": 0.025,
                "hand_speed_scale": 0.12,
                "base_speed_scale": 0.16,
            },
        )
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireStayPlayEnvCfg(RobotLeftHandLocoReachAdapterAcquireStayEnvCfg):
    def __post_init__(self):
        super().__post_init__()
