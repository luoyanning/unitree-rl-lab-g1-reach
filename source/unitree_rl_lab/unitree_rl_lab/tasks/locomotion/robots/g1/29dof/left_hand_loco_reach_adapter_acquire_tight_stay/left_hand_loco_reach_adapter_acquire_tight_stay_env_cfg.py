...
from .left_hand_loco_reach_adapter_acquire_tight_stay_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStayCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStayCurriculumCfg = LeftHandLocoReachAdapterAcquireTightStayCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayPlayEnvCfg(RobotLeftHandLocoReachAdapterAcquireTightStayEnvCfg):
    def __post_init__(self):
        super().__post_init__()
