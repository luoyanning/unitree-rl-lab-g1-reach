...
from .left_hand_loco_reach_adapter_acquire_tight_stay_natural_reach_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStayNaturalReachCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStayNaturalReachCurriculumCfg = LeftHandLocoReachAdapterAcquireTightStayNaturalReachCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachPlayEnvCfg(RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
