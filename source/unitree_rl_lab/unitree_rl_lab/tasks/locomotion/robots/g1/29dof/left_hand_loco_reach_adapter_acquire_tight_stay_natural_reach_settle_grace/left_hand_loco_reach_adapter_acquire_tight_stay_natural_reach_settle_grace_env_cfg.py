...
from .left_hand_loco_reach_adapter_acquire_tight_stay_natural_reach_settle_grace_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleGraceCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleGraceEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleGraceCurriculumCfg = LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleGraceCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleGracePlayEnvCfg(RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleGraceEnvCfg):
    def __post_init__(self):
        super().__post_init__()
