...
from .left_hand_loco_reach_adapter_acquire_tight_stay_natural_reach_settle_short_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortCurriculumCfg = LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortPlayEnvCfg(RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortEnvCfg):
    def __post_init__(self):
        super().__post_init__()
