...
from .left_hand_loco_reach_adapter_acquire_tight_stay_natural_reach_settle_short_freeze_base_reach_mdp import (
    dwell_left_hand_stillness_reward,
    ...
    ready_reach_foot_shuffle_penalty,
    ready_reach_left_arm_joint_acc_penalty,
    ready_reach_left_hand_stillness_reward,
    ready_reach_left_hand_vertical_motion_penalty,
    ready_reach_right_arm_neutral_reward,
    ready_reach_stationary_reward,
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortFreezeBaseReachCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortFreezeBaseReachEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortFreezeBaseReachCurriculumCfg = LeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortFreezeBaseReachCurriculumCfg()
    ...
    def __post_init__(self):
        ...
        long_horizon_params = {
            ...
            "post_success_exit_radius": POST_SUCCESS_DWELL_EXIT_RADIUS,
        ...
        self.actions.JointPositionAction.scale = 0.22
        ...
        self.rewards.ready_reach_right_arm_neutral = RewTerm(
            func=ready_reach_right_arm_neutral_reward,
            weight=2.0,
            params={
                **long_horizon_params,
                "asset_cfg": right_arm_cfg,
                "gate_std": stance_ready_std,
                "joint_dev_scale": 0.28,
            },
        )
        self.rewards.ready_reach_stationary = RewTerm(
            func=ready_reach_stationary_reward,
            weight=5.5,
            params={
                **long_horizon_params,
                "asset_cfg": feet_cfg,
                "gate_std": stance_ready_std,
                "base_lin_speed_scale": 0.06,
                "base_ang_speed_scale": 0.18,
                "foot_speed_scale": 0.045,
            },
        )
        self.rewards.ready_reach_left_hand_stillness = RewTerm(
            func=ready_reach_left_hand_stillness_reward,
            weight=3.5,
            params={
                "asset_cfg": ee_cfg,
                **long_horizon_params,
                "gate_std": stance_ready_std,
                "hand_speed_scale": 0.10,
            },
        )
        self.rewards.ready_reach_left_hand_vertical_motion = RewTerm(
            func=ready_reach_left_hand_vertical_motion_penalty,
            weight=-1.5,
            params={
                "asset_cfg": ee_cfg,
                **long_horizon_params,
                "gate_std": stance_ready_std,
                "vertical_speed_scale": 0.045,
            },
        )
        self.rewards.ready_reach_left_arm_joint_acc = RewTerm(
            func=ready_reach_left_arm_joint_acc_penalty,
            weight=-0.08,
            params={
                "asset_cfg": left_arm_cfg,
                **long_horizon_params,
                "gate_std": stance_ready_std,
                "joint_acc_scale": 18.0,
            },
        )
        self.rewards.ready_reach_foot_shuffle = RewTerm(
            func=ready_reach_foot_shuffle_penalty,
            weight=-1.5,
            params={
                "asset_cfg": feet_cfg,
                **long_horizon_params,
                "gate_std": stance_ready_std,
                "foot_speed_scale": 0.05,
            },
        )
        ...
        self.rewards.post_success_stay = RewTerm(
            func=post_success_stay_reward,
            weight=6.0,
            params={
                "asset_cfg": ee_cfg,
                **long_horizon_params,
                "stay_reward_std": 0.02,
                "hand_speed_scale": 0.10,
                "base_speed_scale": 0.14,
            },
        )
        self.rewards.near_target_left_hand_stillness = RewTerm(
            ...
            params={
                "asset_cfg": ee_cfg,
                **long_horizon_params,
                "near_target_radius": 0.16,
                "hand_speed_scale": 0.08,
            },
        )
        self.rewards.dwell_left_hand_stillness = RewTerm(
            func=dwell_left_hand_stillness_reward,
            weight=4.0,
            params={
                "asset_cfg": ee_cfg,
                **long_horizon_params,
                "hand_speed_scale": 0.04,
            },
        )
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortFreezeBaseReachPlayEnvCfg(RobotLeftHandLocoReachAdapterAcquireTightStayNaturalReachSettleShortFreezeBaseReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
