...
from .left_hand_loco_reach_adapter_acquire_tight_stay_progress_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStayProgressCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayProgressEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStayProgressCurriculumCfg = (
        LeftHandLocoReachAdapterAcquireTightStayProgressCurriculumCfg()
    )
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStayProgressPlayEnvCfg(
