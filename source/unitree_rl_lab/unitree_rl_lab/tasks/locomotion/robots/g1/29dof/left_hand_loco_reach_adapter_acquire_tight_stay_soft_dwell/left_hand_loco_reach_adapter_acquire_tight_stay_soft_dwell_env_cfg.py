...
from .left_hand_loco_reach_adapter_acquire_tight_stay_soft_dwell_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStaySoftDwellCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStaySoftDwellCurriculumCfg = (
        LeftHandLocoReachAdapterAcquireTightStaySoftDwellCurriculumCfg()
    )
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellPlayEnvCfg(
