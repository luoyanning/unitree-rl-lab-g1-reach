...
from .left_hand_loco_reach_adapter_acquire_tight_stay_soft_dwell_hardstart_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartCurriculumCfg = (
        LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartCurriculumCfg()
    )
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartPlayEnvCfg(
