...
from .left_hand_loco_reach_adapter_acquire_tight_stay_soft_dwell_hardstart_handstill_mdp import (
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartHandStillCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartHandStillEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartHandStillCurriculumCfg = (
        LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartHandStillCurriculumCfg()
    )
    ...
    def __post_init__(self):
        ...
        # Start from the final target distribution so resumed checkpoints do not
        # spend time relearning near-only easy targets.
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartHandStillPlayEnvCfg(
