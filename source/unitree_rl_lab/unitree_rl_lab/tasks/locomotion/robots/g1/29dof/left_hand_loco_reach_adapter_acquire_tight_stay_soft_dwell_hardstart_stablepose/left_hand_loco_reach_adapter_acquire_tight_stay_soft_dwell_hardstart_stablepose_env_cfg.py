...
from .left_hand_loco_reach_adapter_acquire_tight_stay_soft_dwell_hardstart_stablepose_mdp import (
    dwell_right_arm_neutral_reward,
    dwell_stationary_reward,
...
@configclass
class LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartStablePoseCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartStablePoseEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartStablePoseCurriculumCfg = (
        LeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartStablePoseCurriculumCfg()
    )
...
@configclass
class RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartStablePosePlayEnvCfg(
    RobotLeftHandLocoReachAdapterAcquireTightStaySoftDwellHardStartStablePoseEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
