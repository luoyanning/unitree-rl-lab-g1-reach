...
from .left_hand_loco_reach_adapter_hold_stay_mdp import (
...
@configclass
class LeftHandLocoReachAdapterHoldStayCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachAdapterHoldStayEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachAdapterHoldStayCurriculumCfg = LeftHandLocoReachAdapterHoldStayCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachAdapterHoldStayPlayEnvCfg(RobotLeftHandLocoReachAdapterHoldStayEnvCfg):
    def __post_init__(self):
        super().__post_init__()
