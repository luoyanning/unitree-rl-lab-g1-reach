...
from .left_hand_loco_reach_restore_mdp import (
...
@configclass
class LeftHandLocoReachRestoreCurriculumCfg(BaseCurriculumCfg):
...
@configclass
class RobotLeftHandLocoReachRestoreEnvCfg(RobotEnvCfg):
    curriculum: LeftHandLocoReachRestoreCurriculumCfg = LeftHandLocoReachRestoreCurriculumCfg()
...
@configclass
class RobotLeftHandLocoReachRestorePlayEnvCfg(RobotLeftHandLocoReachRestoreEnvCfg):
    def __post_init__(self):
        super().__post_init__()
