...
@configclass
class RobotLeftHandLocoReachTableTopMultiTouchPairCleanEnvCfg(RobotLeftHandLocoReachTableTopCleanBaseEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        _set_task_params(
            self,
            ...
            pretouch_height=0.04,
            pretouch_radius=0.12,
            pretouch_hold_steps=3,
            pretouch_stability_gate=0.10,
            touch_height_offset=0.01,
            touch_radius=0.085,
            touch_hold_steps=5,
            touch_stability_gate=0.16,
            recover_radius=0.14,
            recover_hold_steps=5,
            recover_stability_gate=0.18,
            hand_speed_threshold=0.45,
            support_force_threshold=4.0,
        )
        self.episode_length_s = 26.0
        self.commands.base_velocity.resampling_time_range = (self.episode_length_s, self.episode_length_s)
        self.rewards.stance_anchor.weight = -0.45
        self.rewards.stance_stability.weight = 2.0
        self.rewards.phase_progress.weight = 5.0
        self.rewards.phase_tracking.weight = 4.8
        self.rewards.phase_hold.weight = 4.8
        self.rewards.lift_intent.weight = 0.35
        self.rewards.pretouch_bonus.weight = 3.0
        self.rewards.touch_bonus.weight = 8.0
        self.rewards.target_completion.weight = 18.0
        self.rewards.target_age.weight = -1.0
...
class RobotLeftHandLocoReachTableTopMultiTouchCleanEnvCfg(RobotLeftHandLocoReachTableTopCleanBaseEnvCfg):
    def __post_init__(self):
        ...
        _set_task_params(
            ...
            pretouch_radius=0.12,
            pretouch_hold_steps=3,
            pretouch_stability_gate=0.12,
            touch_height_offset=0.01,
            touch_radius=0.085,
            touch_hold_steps=6,
            touch_stability_gate=0.18,
            recover_radius=0.14,
            recover_hold_steps=6,
            recover_stability_gate=0.20,
            hand_speed_threshold=0.45,
            support_force_threshold=4.0,
        )
        self.episode_length_s = 34.0
        self.commands.base_velocity.resampling_time_range = (self.episode_length_s, self.episode_length_s)
        self.rewards.stance_anchor.weight = -0.55
        self.rewards.stance_stability.weight = 2.4
        self.rewards.phase_progress.weight = 4.0
        self.rewards.phase_tracking.weight = 4.8
        self.rewards.phase_hold.weight = 5.4
        self.rewards.lift_intent.weight = 0.25
        self.rewards.pretouch_bonus.weight = 3.0
        self.rewards.touch_bonus.weight = 8.5
        self.rewards.target_completion.weight = 22.0
        self.rewards.target_age.weight = -1.2
        self.rewards.support_contact.weight = -0.55
...
class RobotLeftHandLocoReachTableTopFixedAcquireStayEnvCfg(
    ...
    def __post_init__(self):
        ...
        _set_task_params(
            ...
            randomize_order=False,
            max_targets_per_episode=1,
            per_target_timeout_s=12.0,
            stance_anchor_std=0.22,
            stance_anchor_tolerance=0.13,
            base_speed_threshold=0.28,
            torso_lean_threshold=0.64,
            stability_speed_scale=0.30,
            stability_lean_scale=0.54,
            pretouch_backoff_x=0.02,
            pretouch_height=0.03,
            pretouch_radius=0.11,
            pretouch_hold_steps=3,
            pretouch_stability_gate=0.10,
            touch_height_offset=0.01,
            ...
            recover_stability_gate=0.18,
            hand_speed_threshold=0.32,
            support_force_threshold=6.0,
        )

        self.events.reset_base.params["pose_range"] = {"x": (-0.02, 0.02), "y": (-0.02, 0.02), "yaw": (-0.08, 0.08)}
        self.events.reset_base.params["velocity_range"] = {
            "x": (0.0, 0.0),
            "y": (0.0, 0.0),
            "z": (0.0, 0.0),
        ...
        self.rewards.stance_anchor.weight = -0.45
        self.rewards.stance_stability.weight = 2.2
        self.rewards.phase_progress.weight = 4.5
        self.rewards.phase_tracking.weight = 5.2
        self.rewards.phase_hold.weight = 7.5
        self.rewards.lift_intent.weight = 0.20
        self.rewards.pretouch_bonus.weight = 3.5
        self.rewards.touch_bonus.weight = 10.0
        self.rewards.target_completion.weight = 26.0
        self.rewards.target_age.weight = -0.35
        self.rewards.support_contact.weight = -0.20
        self.rewards.left_hand_tracking.weight = 3.0
        self.rewards.phase_tracking.params["std"] = 0.08
        self.rewards.left_hand_tracking.params["std"] = 0.06

        self.terminations.base_height.params["minimum_height"] = 0.18
        self.terminations.bad_orientation.params["limit_angle"] = 0.80
        self.terminations.body_support_contact = DoneTerm(
            func=tabletop_clean_mdp.support_contact_termination,
            params={
                **self.observations.policy.velocity_commands.params,
                "termination_force_threshold": 40.0,
            },
        )
...
class RobotLeftHandLocoReachTableTopFixedAcquireStayAnchorTightPlayEnvCfg(
    ...
    def __post_init__(self):
        ...
        _set_task_params(
            ...
            randomize_order=False,
            max_targets_per_episode=3,
            stance_anchor_std=0.32,
            stance_anchor_tolerance=0.18,
            base_speed_threshold=0.65,
            torso_lean_threshold=0.95,
            stability_speed_scale=0.65,
            stability_lean_scale=0.90,
...
@configclass
class RobotLeftHandLocoReachTableTopMultiTouchPairCleanPlayEnvCfg(
    RobotLeftHandLocoReachTableTopMultiTouchPairCleanEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
